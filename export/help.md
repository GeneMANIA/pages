...
id: 14
title: Help
date: 2011-05-25T15:35:10+00:00
author: admin
layout: page
guid: http://192.168.81.148/?page_id=14
---
[toc]
...
## GeneMANIA search tips
  ...
  * GeneMANIA will be slower with an input gene list of more than 50 genes; if you have such large gene lists, we recommend using a gene list of no more than 100 genes. The GeneMANIA [Cytoscape plugin](/page/plugin) is capable of handling larger gene lists.
...
[<img class="alignnone size-full wp-image-155" title="GEO" src="http://pages.genemania.org/wp-content/uploads/2011/05/geo.gif" alt="" width="146" height="67" />](http://www.ncbi.nlm.nih.gov/geo) [ <img class="alignnone size-full wp-image-156" title="BioGRID" src="http://pages.genemania.org/wp-content/uploads/2011/05/biogrid.png" alt="" width="150" height="37" />](http://www.thebiogrid.org/)[<img class="alignnone size-full wp-image-157" title="EMBL-EBI" src="http://pages.genemania.org/wp-content/uploads/2011/05/embl-ebi.png" alt="" width="150" height="62" />](http://www.ebi.ac.uk/interpro) [<img class="alignnone size-full wp-image-158" title="Pfam" src="http://pages.genemania.org/wp-content/uploads/2011/05/pfam.png" alt="" width="150" height="59" />](http://pfam.sanger.ac.uk/) [<img class="alignnone size-full wp-image-159" title="Ensembl" src="http://pages.genemania.org/wp-content/uploads/2011/05/ensembl.png" alt="" width="150" height="40" />](http://www.ensembl.org/) [<img class="alignnone size-full wp-image-160" title="NCBI" src="http://pages.genemania.org/wp-content/uploads/2011/05/ncbi.gif" alt="" width="130" height="45" />](http://www.ncbi.nlm.nih.gov/) [<img class="alignnone size-full wp-image-161" title="MGI" src="http://pages.genemania.org/wp-content/uploads/2011/05/mgi.gif" alt="" width="115" height="61" />](http://www.informatics.jax.org/) [<img class="alignnone size-full wp-image-162" title="I2D" src="http://pages.genemania.org/wp-content/uploads/2011/05/i2d.jpg" alt="" width="150" height="23" />](http://www.informatics.jax.org/) [<img class="alignnone size-full wp-image-163" title="InParanoid" src="http://pages.genemania.org/wp-content/uploads/2011/05/inp7.png" alt="" width="150" height="36" />](http://inparanoid.sbc.su.se/) [<img class="alignnone size-full wp-image-164" title="Pathway Commons" src="http://pages.genemania.org/wp-content/uploads/2011/05/pathway-commons.png" alt="" width="266" height="77" />](http://www.pathwaycommons.org/)

We maintain a [complete list of networks currently in the GeneMANIA system](http://pages.genemania.org/networks/ "List of networks used in GeneMANIA").
